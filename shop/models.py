...
class Brand(models.Model):
    """Модель для Brand товаров"""
    name_brand = models.CharField(max_length=255, verbose_name='Имя Brand', null=True)
    slug = models.SlugField(unique=True)

    class Meta:
        """Используем для задания параметров в админке, без необходимости добавления новых полей в саму модель. """
        ordering = ('name_brand',)  # сортировка применяется и в отображении в админке и в шаблонах
        verbose_name = 'Brand'
...
class Product(models.Model):
    ...
    image2 = models.ImageField(verbose_name='Изображение2', null=True)
    image3 = models.ImageField(verbose_name='Изображение3', null=True)
    image4 = models.ImageField(verbose_name='Изображение4', null=True)
